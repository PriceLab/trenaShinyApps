vizmap = [
   ...
   {selector: "node[type='TF'][pearsonCoeff>0]", css: {
      "shape": "ellipse",
      "background-color": "mapData(pearsonCoeff, 0.5, 1.0, white, red)",
      "width": "mapData(rfScore, 0.0, 5.0, 20.0, 200.0)",
      "height":"mapData(rfScore, 0.0, 5.0, 20.0, 200.0)"
       }},
   ...
   {selector: "node[type='TF'][pearsonCoeff<=0]", css: {
      "shape": "ellipse",
      "background-color": "mapData(pearsonCoeff, -1.0, -0.5, green, white)",
      "width": "mapData(rfScore, 0.0, 5.0, 20.0, 200.0)",
      "height":"mapData(rfScore, 0.0, 5.0, 20.0, 200.0)"
       }},
